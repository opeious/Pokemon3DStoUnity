...
namespace P3DS2U.Editor.SPICA.H3D.Model.Material
{
    ...
    public class H3DMaterial : ICustomSerialization, INamed
    {
        ...
        [FixedLength (3)] [IfVersion (CmpOp.Gequal, 0x21)]
        public readonly H3DTextureMapper[] TextureMappers;
         ...
         */
        [FixedLength (3)] [IfVersion (CmpOp.Less, 0x21)] [Inline]
        private readonly H3DTextureMapper[] TextureMappersCompat;
        ...
        {
            var Reader = new PICACommandReader (TextureCommands);
            ...
            if (TextureMappersCompat != null) Array.Copy (TextureMappersCompat, TextureMappers, 3);
        }
        ...
        bool ICustomSerialization.Serialize (BinarySerializer Serializer)
        {
            ...
            if (TextureMappersCompat != null) Array.Copy (TextureMappers, TextureMappersCompat, 3);
