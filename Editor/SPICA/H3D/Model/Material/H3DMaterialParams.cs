...
namespace P3DS2U.Editor.SPICA.H3D.Model.Material
{
    public class H3DMaterialParams : ICustomSerialization, INamed
    {
        ...
        public H3DMaterialParams ()
        {
            ...
            for (var Index = 0; Index < TexEnvStages.Length; Index++) TexEnvStages[Index] = new PICATexEnvStage ();
        ...
        void ICustomSerialization.Deserialize (BinaryDeserializer Deserializer)
        {
            ...
            while (Reader.HasCommand) {
                ...
                var Stage = ((int) Cmd.Register >> 3) & 7;
                ...
                switch (Cmd.Register) {
                    ...
                    case PICARegister.GPUREG_TEXENV_BUFFER_COLOR:
                        TexEnvBufferColor = new RGBA (Param);
                        break;
        ...
        bool ICustomSerialization.Serialize (BinarySerializer Serializer)
        {
            ...
            for (var Stage = 0; Stage < 6; Stage++) {
                ...
                switch (Stage) {
                    case 0:
                        Register = PICARegister.GPUREG_TEXENV0_SOURCE;
                        break;
                    case 1:
                        Register = PICARegister.GPUREG_TEXENV1_SOURCE;
                        break;
                    case 2:
                        Register = PICARegister.GPUREG_TEXENV2_SOURCE;
                        break;
                    case 3:
                        Register = PICARegister.GPUREG_TEXENV3_SOURCE;
                        break;
                    case 4:
                        Register = PICARegister.GPUREG_TEXENV4_SOURCE;
                        break;
                    case 5:
                        Register = PICARegister.GPUREG_TEXENV5_SOURCE;
                        break;
                }
            ...
            var UpdateBuffer = PICATexEnvStage.GetUpdateBuffer (TexEnvStages);
        ...
        {
            if (Stage >= 0 && Stage < 6) return (ConstantColors >> (Stage * 4)) & 0xf;
