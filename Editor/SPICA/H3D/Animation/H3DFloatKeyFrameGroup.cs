...
namespace SPICA.Formats.CtrH3D.Animation
{
    public class H3DFloatKeyFrameGroup : H3DAnimationCurve, ICustomSerialization
    {
            ...
            for (var Index = 0; Index < Count; Index++) {
                ...
                switch (Quantization) {
                    case KeyFrameQuantization.Hermite128:
                        KF = Deserializer.Reader.ReadHermite128 ();
                        break;
                    case KeyFrameQuantization.Hermite64:
                        KF = Deserializer.Reader.ReadHermite64 ();
                        break;
                    case KeyFrameQuantization.Hermite48:
                        KF = Deserializer.Reader.ReadHermite48 ();
                        break;
                    case KeyFrameQuantization.UnifiedHermite96:
                        KF = Deserializer.Reader.ReadUnifiedHermite96 ();
                        break;
                    case KeyFrameQuantization.UnifiedHermite48:
                        KF = Deserializer.Reader.ReadUnifiedHermite48 ();
                        break;
                    case KeyFrameQuantization.UnifiedHermite32:
                        KF = Deserializer.Reader.ReadUnifiedHermite32 ();
                        break;
                    case KeyFrameQuantization.StepLinear64:
                        KF = Deserializer.Reader.ReadStepLinear64 ();
                        break;
                    case KeyFrameQuantization.StepLinear32:
                        KF = Deserializer.Reader.ReadStepLinear32 ();
                        break;
        ...
        bool ICustomSerialization.Serialize (BinarySerializer Serializer)
        {
            ...
            var MinFrame = KeyFrames.Count > 0 ? KeyFrames[0].Frame : 0;
            var MaxFrame = KeyFrames.Count > 0 ? KeyFrames[0].Frame : 0;
            var MinValue = KeyFrames.Count > 0 ? KeyFrames[0].Value : 0;
            var MaxValue = KeyFrames.Count > 0 ? KeyFrames[0].Value : 0;
            ...
            foreach (var Key in KeyFrames) {
                ...
                switch (Quantization) {
                    case KeyFrameQuantization.Hermite128:
                        Serializer.Writer.WriteHermite128 (KF);
                        break;
                    case KeyFrameQuantization.Hermite64:
                        Serializer.Writer.WriteHermite64 (KF);
                        break;
                    case KeyFrameQuantization.Hermite48:
                        Serializer.Writer.WriteHermite48 (KF);
                        break;
                    case KeyFrameQuantization.UnifiedHermite96:
                        Serializer.Writer.WriteUnifiedHermite96 (KF);
                        break;
                    case KeyFrameQuantization.UnifiedHermite48:
                        Serializer.Writer.WriteUnifiedHermite48 (KF);
                        break;
                    case KeyFrameQuantization.UnifiedHermite32:
                        Serializer.Writer.WriteUnifiedHermite32 (KF);
                        break;
                    case KeyFrameQuantization.StepLinear64:
                        Serializer.Writer.WriteStepLinear64 (KF);
                        break;
                    case KeyFrameQuantization.StepLinear32:
                        Serializer.Writer.WriteStepLinear32 (KF);
                        break;
                }
            }
        ...
        {
            var FrameGrp = new H3DFloatKeyFrameGroup ();
        ...
        public float GetFrameValue (float Frame)
        {
            ...
            var LHS = KeyFrames.First ();
            var RHS = KeyFrames.Last ();
                ...
                switch (InterpolationType) {
                    ...
                    default:
                        throw new InvalidOperationException (
                            $"Invalid Interpolation type {InterpolationType}!");
                }
            }
