...
namespace P3DS2U.Editor.SPICA.H3D
{
    public struct H3DVertexData : ICustomSerialization
    {
        ...
        void ICustomSerialization.Deserialize (BinaryDeserializer Deserializer)
        {
            ...
            var AttributesAddress = Deserializer.Reader.ReadUInt32 ();
            var IndicesAddress = Deserializer.Reader.ReadUInt32 ();

            Deserializer.BaseStream.Seek (AttributesAddress, SeekOrigin.Begin);

            var BaseAddress = int.MaxValue;
            ...
            for (var Index = 0; Index < Attributes.Length; Index++)
                if (!Attributes[Index].IsFixed) {
                    ...
                    var Size = Attributes[Index].Elements;
        ...
        {
            for (var Index = 0; Index < Attributes.Length; Index++) Attributes[Index].RawBuffer = RawBuffer;
